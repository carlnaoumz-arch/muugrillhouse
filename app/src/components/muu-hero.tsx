...
export function Hero(){
 ...
 {src&&!failed&&<div className="hero-caption"><button onClick={toggle} className="film-control" aria-label={playing?'Pause hero film':'Play hero film'}>{playing?'Ⅱ':'▷'}</button></div>}
 </section>
}
